...
- Проверяет, что maxTemperature больше или равно minTemperature и выбрасывает исключение invalid_argument, если условие не выполняется.
...
- Проверка корректности:
Проверяет, что energy неотрицательное и выбрасывает исключение invalid_argument, если условие не выполняется.
